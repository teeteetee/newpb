   ...
   function check_db () {
    ...
    function sort_response () {
      if(dynamic_msgstore && dynamic_msgstore[dynamic_msgstore.length-1].tmstmp>vtmstmp)
        ...
        {
          var sht_tmp ={};
           sht_tmp['$set'] = {$set:{tmstmpstore:{g_vdiscid:vlsttmstmp}}};
