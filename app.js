...
app.post('/newuser',function(req,res){
    ...
    //checkmail function was here before being moved out of scope
      ...
      counter_books.insert({uid:done._id.toString(),total:0,oldones:0,newones:0,bookstore:[]});
      counter_movies.insert({uid:done._id.toString(),total:0,oldones:0,newones:0,moviestore:[]});
      counter_friends.insert({uid:done._id.toString(),total_fd:0,total_fl:0,friendstore:[],followers:[]});
